...
<template>
  ...
  <main class="relative min-h-screen bg-black text-white ">
    <HeroSection :image="dungeon" overlay-color="rgba(80, 20, 5, 0.6)">
      ...
      <div class="flex items-center justify-center min-h-[80vh] px-4 py-8 mt-16">
